...
//
//     final nowPlayingMovieModel = nowPlayingMovieModelFromJson(jsonString);

import 'dart:convert';

NowPlayingMovieModel nowPlayingMovieModelFromJson(String str) =>
    NowPlayingMovieModel.fromJson(json.decode(str));

String nowPlayingMovieModelToJson(NowPlayingMovieModel data) =>
    json.encode(data.toJson());

class NowPlayingMovieModel {
  Dates? dates;
  int? page;
  List<NowPlayingMovieList>? results;
  int? totalPages;
  int? totalResults;
  ...
  factory NowPlayingMovieModel.fromJson(Map<String, dynamic> json) =>
      NowPlayingMovieModel(
        ...
        results: json["results"] == null
            ? []
            : List<NowPlayingMovieList>.from(
                json["results"]!.map((x) => NowPlayingMovieList.fromJson(x))),
